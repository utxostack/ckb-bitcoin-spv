...
impl SpvClient {
    ...
    pub const FIELD_SIZES: [usize; 4] = [1, 32, 40, 8];
    ...
    pub fn headers_mmr_root(&self) -> HeaderDigest {
        HeaderDigest::new_unchecked(self.0.slice(33..73))
    }
    pub fn target_adjust_info(&self) -> TargetAdjustInfo {
        TargetAdjustInfo::new_unchecked(self.0.slice(73..81))
    }
...
impl<'r> SpvClientReader<'r> {
    ...
    pub fn headers_mmr_root(&self) -> HeaderDigestReader<'r> {
        HeaderDigestReader::new_unchecked(&self.as_slice()[33..73])
    }
    pub fn target_adjust_info(&self) -> TargetAdjustInfoReader<'r> {
        TargetAdjustInfoReader::new_unchecked(&self.as_slice()[73..81])
    }
}
